...
export class UserProfileService {
  ...
  findAllByCompanyId(body?: any): Observable<any> {
    return this.http.post<any>(
      `${this.api.getCatalogApi()}/find-all-by-company-id`,
      body,
      {
        observe: "response",
      }
  ...
  public findUserByGroupId(body?: any): Observable<any> {
    return this.http.post<any>(
      `${this.api.getCatalogApi()}/list-user-by-group-id`,
      body,
      {
        observe: "response",
      }
  ...
  public listUserWorkSpaceId(body?: any): Observable<any> {
    return this.http.post<any>(
      `${this.api.getCatalogApi()}/list-user-by-workspace-id`,
      body,
      {
        observe: "response",
      }
  ...
  public search(body?: any): Observable<any> {
    return this.http.post<any[]>(
      `${this.api.getCatalogApi()}/user/on-search`,
      body,
      {
        observe: "response",
      }
  ...
  public changePassword(body?: any): Observable<any> {
    return this.http.post<any>(
      `${this.api.getCatalogApi()}/change-pass-word`,
      body,
      {
        observe: "response",
      }
  ...
  public updateUser(body?: any): Observable<any> {
    return this.http.post<any>(
      `${this.api.getCatalogApi()}/update-user`,
      body,
      {
        observe: "response",
      }
  ...
  public findUserNoPassword(body?: any): Observable<any> {
    return this.http.post<any>(
      `${this.api.getCatalogApi()}/get-user-by-username`,
      body,
      {
        observe: "response",
      }
  ...
  public getUserById(body?: any): Observable<any> {
    return this.http.post(`${this.api.getCatalogApi()}/get-user-by-id`, body, {
      observe: "response",
    });
  }
}
